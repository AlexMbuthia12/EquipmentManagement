  ...
  return (
    <main className="login-main w-screen h-screen overflow-hidden flex flex-col justify-center items-center">
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 max-w-md w-4/5 pb-2">
        ...
        <div className="text-[#21130d] hover:underline cursor-pointer pt-2">Forgot Password</div>
      </form>
    </main>
  );
};
